...
#include "point_pubsub/msg/detail/symbol__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const point_pubsub::msg::Symbol *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<point_pubsub::msg::Symbol *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_point_pubsub
const rosidl_message_type_support_t *
get_message_type_support_handle<point_pubsub::msg::Symbol>()
{
  return &point_pubsub::msg::typesupport_fastrtps_cpp::_Symbol__handle;
}
