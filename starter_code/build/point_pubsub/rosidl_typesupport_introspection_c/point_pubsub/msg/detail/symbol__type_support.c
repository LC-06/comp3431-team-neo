...
#include <stddef.h>
#include "point_pubsub/msg/detail/symbol__rosidl_typesupport_introspection_c.h"
#include "point_pubsub/msg/rosidl_typesupport_introspection_c__visibility_control.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  point_pubsub__msg__Symbol__init(message_memory);
}

void Symbol__rosidl_typesupport_introspection_c__Symbol_fini_function(void * message_memory)
{
  point_pubsub__msg__Symbol__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Symbol__rosidl_typesupport_introspection_c__Symbol_message_member_array[2] = {
  {
    ...
    offsetof(point_pubsub__msg__Symbol, data),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(point_pubsub__msg__Symbol, points),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Symbol__rosidl_typesupport_introspection_c__Symbol_message_members = {
  "point_pubsub__msg",  // message namespace
  "Symbol",  // message name
  2,  // number of fields
  sizeof(point_pubsub__msg__Symbol),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_point_pubsub
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, point_pubsub, msg, Symbol)() {
