...
bool point_msg_interface__msg__pointmsg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("point_msg_interface.msg._pointmsg.Pointmsg", full_classname_dest, 42) == 0);
  }
...
PyObject * point_msg_interface__msg__pointmsg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("point_msg_interface.msg._pointmsg");
